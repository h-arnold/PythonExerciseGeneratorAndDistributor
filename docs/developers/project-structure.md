...
│   ├── autograder.py          # Generic Classroom 50 bundle grader (teacher-side)
│   ├── build_classroom50_bundle.py  # Builds a teacher-side grading bundle
│   ├── jupyter_watchdog.py
│   ├── new_exercise.py
...
│   ├── verify_solutions.sh
│   └── template_repo_cli/
├── template_repo_files/       # Source files for generating Classroom 50 template repositories
...
- `docs/developers/` — Developer and contributor documentation (setup, architecture, testing framework, execution model)

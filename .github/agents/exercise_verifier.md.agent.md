...
- If there is an optional self-check cell, verify it uses `check_notebook('<slug>')` (for example, `check_notebook('ex007_data_types_debug_casting')`) so output remains aligned with the grouped student checker summary.

...
| `ex002_sequence_modify_basics` | `exercises/sequence/modify/ex002_sequence_modify_basics/` | `notebooks/ex002_sequence_modify_basics.ipynb` | `notebooks/solutions/ex002_sequence_modify_basics.ipynb` | `tests/test_ex002_sequence_modify_basics.py`; `tests/ex002_sequence_modify_basics/test_ex002_sequence_modify_basics.py` | Duplicate exercise-specific test locations; template CLI fixture data points at the nested test path while the collector code points at the top-level test path. Canonical exercise-local tests live under `tests/ex002_sequence_modify_basics/test_ex002_sequence_modify_basics.py`, and the top-level `tests/test_ex002_sequence_modify_basics.py` is a legacy duplicate to retire once canonical discovery is enforced. |
...
- [ ] The nested `tests/ex002_sequence_modify_basics/test_ex002_sequence_modify_basics.py` surface is the canonical exercise-local test for `ex002_sequence_modify_basics`; retire the top-level `tests/test_ex002_sequence_modify_basics.py` once duplicate-collection guards are in place so discovery only sees the canonical file.

...
**For exercise creation**: Use the Exercise Generation Codex agent (`.codex/agents/exercise_generation.md.agent.md`).

**Main agent orchestration**: There is no separate Codex orchestrator config in this repo. The primary Codex agent should follow these repo instructions and delegate to the available specialist agents as needed:

- Exercise generation → `.codex/agents/exercise_generation.md.agent.md`
- Exercise verification → `.codex/agents/exercise_verifier.md.agent.md`
- Implementation work → `.codex/agents/implementer.md.agent.md`
- Post-change tidy review → `.codex/agents/tidy_code_review.md.agent.md`

**Documentation (fetch on demand)**: Only read these files when a question specifically requires detailed information.

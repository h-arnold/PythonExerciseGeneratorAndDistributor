...
## Teacher notes
- Created: 2026-06-08
- Target concepts: Squaring (`n ** 2`), cubing (`n ** 3`), square root (`n ** 0.5`), exponentiation/power (`base ** exponent`), combining `**` with `input()`, casting, and constants.
- Prerequisites: Variables, `input()`, `print()`, f-strings, `int()` and `float()` casting, multiplication.
- Exercise type: Gap-fill with 10 parts. Exercises 1-2 use hardcoded values; 3-10 require `input()`. Scaffolding decreases from ex6 to ex10.

...
- Target concepts:
  ...
  - **No variables** at this stage — only literals
- Exercise type: **Modification** (students modify working code)
- Difficulty progression:
  - Exercises 1-5: Single simple changes (one word, one operation)
  - Exercises 6-10: Multiple elements or slightly more complex modifications
- Total exercises: 10
...
4. Understanding that operators (+, -, *, /) work on numbers
5. Learning that strings can be joined with `+`

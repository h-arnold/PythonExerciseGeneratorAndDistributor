...
- Focus: Simple `if` statements with `==`, `!=`, `<`, and `>` comparison operators. Students modify working programs by changing the condition value, comparison operator, threshold number, or output message.
...
- Comparison operators covered: `==` (ex1, ex9), `!=` (ex3, ex5, ex7, ex10), `<` (ex4), `>` (ex2, ex6, ex8)

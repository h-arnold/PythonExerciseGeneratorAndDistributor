---
name: docs
description: Reviews changed code and updates developer documentation, AGENTS guidance, and JSDoc accuracy for PythonExerciseGeneratorAndDistributor.
...
1. **Developer documentation updates:**
   ...
   - For exercise-local layout or grading changes, keep canonical guidance aligned with `docs/project-structure.md`, `docs/execution-model.md`, `docs/testing-framework.md`, and `docs/development.md`

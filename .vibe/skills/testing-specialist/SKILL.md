...
description: Verifies repository infrastructure tests, exercise-local tests, notebook grading, autograding tooling, scaffolding, and template repo tooling for PythonExerciseGeneratorAndDistributor.

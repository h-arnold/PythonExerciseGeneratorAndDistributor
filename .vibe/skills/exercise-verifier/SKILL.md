...
description: Verify canonical exercise-local exercises meet repo standards (type rules, sequencing, tests, and teacher guidance) for PythonExerciseGeneratorAndDistributor.
